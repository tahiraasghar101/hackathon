...
const slides = [
  {
    ...
    buttonText: "Shop Now",
    chairImage: "/chair-img.png",  // Updated to chair-img.png
    lampImage: "/lamp.png", // Updated to lamp.png
  },
  {
  ...
  return (
    <section className="relative bg-gray-100 py-10 md:py-20 px-5 md:px-20 flex flex-col md:flex-row items-center justify-between overflow-hidden">
      ...
      <div className="md:w-1/4 flex justify-center items-start relative">
        <div className="absolute top-[-150px] md:top-[-350px] left-[-40px] z-10">
          <Image
            src={current.lampImage}  // Reference to lamp.png
            alt="Lamp"
      ...
      <div className="md:w-1/3 max-w-lg text-center md:text-left flex flex-col justify-center md:pl-10">
      ...
      <div className="md:w-1/3 flex justify-center items-center relative">
        <div className="relative bg-gradient-to-r from-pink-100 to-purple-200 rounded-full p-10 shadow-xl mt-10 mx-auto">
          <Image
            src={current.chairImage}  // Reference to chair-img.png
            alt="Furniture Chair"
            width={706}
            height={689}
